      ...
      >
        <div className="space-y-2 text-left">
          ...
          <motion.h3
            ...
            className="text-sm md:text-md lg:text-xl text-gray-500"
          >
          ...
          return (
            ...
            >
              ...
              >
                ...
                >
                  {isOpen ? (
                    <Minus className="text-secondary lg:w-6 lg:h-6 md:w-4 md:h-4 w-3 h-3" />
                  ) : (
                    <Plus className="text-secondary lg:w-6 lg:h-6 md:w-4 md:h-4 w-3 h-3" />
                  )}
                </motion.span>
              </button>
              ...
              <AnimatePresence initial={false}>
                {isOpen && (
                  ...
                  >
                    <p className="text-gray-400 lg:text-xl md:text-lg text-sm mx-4 px-2 py-2">
                      {faq.answer}
                    </p>
                  </motion.div>
                )}
