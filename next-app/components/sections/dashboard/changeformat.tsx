    ...
    <>
      {final_url === "" && (
        <div className="flex flex-col items-center justify-center gap-4 w-full p-8 text-center">
          <h1 className="text-4xl font-bold text-main">Change Format</h1>
          <p className="text-lg -mt-2 text-gray-400">
            Change format of your image effeciently and lossless using
            Refyned.AI.
          </p>
          {!image && (
            <div className="mt-2">
          ...
          {image && (
            <div className="w-[25vw] space-y-4">
              <div className="p-2 w-full bg-card rounded-2xl">
                <Select
                  value={format}
                  onValueChange={(value) => setFormat(value)}
                >
                  <SelectTrigger className="w-full border-none text-main cursor-pointer">
                    <SelectValue placeholder="Select format" />
                  </SelectTrigger>
                  <SelectContent className="bg-card border-none text-main cursor-pointer">
